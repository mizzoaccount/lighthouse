    ...
    <div className="bg-white min-h-screen">
      ...
      <main className="pt-24 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          className="bg-white rounded-xl border border-blue-600 shadow-sm p-6"
        >
          {activeTab === "profile" && (
            <div>
              <div className="flex justify-between items-center mb-6">
                ...
                {!isEditing ? (
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-600 text-black font-bold rounded-full transition-colors"
                  >
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-blue-600 hover:bg-blue-600 text-black font-bold rounded-full transition-colors"
                    >
                      Save Changes
                    </button>
                  </div>
             ...
             {/*} {isLoadingOrders ? (
                ...
                <div className="text-center py-10">
                  ...
                  <button
                    ...
                    className="mt-4 px-4 py-2 bg-blue-600 hover:bg-blue-600 text-black font-bold rounded-full transition-colors"
                  >
                    Start Shopping
                  </button>
                </div>
