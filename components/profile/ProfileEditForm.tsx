...
export const ProfileEditForm = ({
  ...
  <form onSubmit={onSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-8">
    ...
    <div className="col-span-2 flex justify-end gap-4 mt-4">
      ...
      <button
        type="submit"
        className="px-6 py-2 bg-gradient-to-r from-blue-600 to-blue-400 hover:from-blue-700 hover:to-blue-500 text-white font-bold rounded-full transition-colors"
      >
        Save Changes
      </button>
    </div>
...
const AddressForm = ({
  ...
  <div className="border border-blue-600 rounded-lg p-4">
    ...
    <div className="space-y-3">
      <div>
        <label htmlFor={`${type}Street`} className="block text-xs font-medium text-gray-700 mb-1">
          Street
        </label>
        <input
          type="text"
          ...
          onChange={onInputChange}
          className="w-full px-3 py-1 text-sm border border-gray-300 rounded focus:ring-blue-600 focus:border-blue-600"
          required
        />
      </div>
      <div className="grid grid-cols-2 gap-3">
        <div>
          <label htmlFor={`${type}City`} className="block text-xs font-medium text-gray-700 mb-1">
            City
          </label>
          <input
            type="text"
        ...
        <div>
          <label htmlFor={`${type}State`} className="block text-xs font-medium text-gray-700 mb-1">
            State
          </label>
          <input
            type="text"
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          <label htmlFor={`${type}Zip`} className="block text-xs font-medium text-gray-700 mb-1">
            ZIP Code
          </label>
          <input
            type="text"
        ...
        <div>
          <label htmlFor={`${type}Country`} className="block text-xs font-medium text-gray-700 mb-1">
            Country
          </label>
          <input
            type="text"
