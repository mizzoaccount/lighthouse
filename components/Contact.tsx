          ...
          >
            <form className="space-y-6">
              ...
              <div>
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-blue-600 to-blue-400 text-white px-6 py-3 rounded-lg font-medium hover:bg-gradient-to-r hover:from-blue-700 hover:to-blue-500 transition-colors"
                >
                  Send Message
                </button>
              </div>
